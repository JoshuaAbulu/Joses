...
const Baby = () => {
    ...
    const useInput = useContext(ValueContext)
      ...
      setBabyValue(input1.value + input2.value + input3.value + input4.value + input5.value + input6.value)
                    ...
                    <div className='flex bg-orange-400 w-2/3 rounded-2xl justify-center place-items-center gap-4 p-2'>
                        <button onClick = {() => 
                            {setTotalValue(totalValue+input1.value);
                                setEachItem((prev) => {
                                    const newObj = {...prev, name: 'Baby Cloth', number: input1.value, price: price.babyCloth}
                                    setItems((prev) => {
                    ...
                    <div className='flex bg-orange-400 w-2/3 rounded-2xl justify-center place-items-center gap-4 p-2'>
                        <button onClick = {() => 
                            {setTotalValue(totalValue+input2.value);
                                setEachItem((prev) => {
                                    const newObj = {...prev, name: 'Baby Cloth', number: input2.value, price: price.babyCloth}
                                    setItems((prev) => {
                                        const newArr = [...prev, newObj]
                                        return newArr
                                    });
                    ...
                    <div className='flex bg-orange-400 w-2/3 rounded-2xl justify-center place-items-center gap-4 p-2'>
                        <button onClick = {() => 
                            {setTotalValue(totalValue+input3.value);
                                setEachItem((prev) => {
                                    const newObj = {...prev, name: 'Baby Cloth', number: input3.value, price: price.babyCloth}
                                    setItems((prev) => {
                                        const newArr = [...prev, newObj]
                                        return newArr
                                    });
                    ...
                    <div className='flex bg-orange-400 w-2/3 rounded-2xl justify-center place-items-center gap-4 p-2'>
                        <button onClick = {() => 
                            {setTotalValue(totalValue+input4.value); 
                                setEachItem((prev) => {
                                    const newObj = {...prev, name: 'Baby Cloth', number: input4.value, price: price.babyCloth}
                                    setItems((prev) => {
                                        const newArr = [...prev, newObj]
                                        return newArr
                                    });
                    ...
                    <div className='flex bg-orange-400 w-2/3 rounded-2xl justify-center place-items-center gap-4 p-2'>
                        <button onClick = {() => 
                            {setTotalValue(totalValue+input5.value);
                                setEachItem((prev) => {
                                    const newObj = {...prev, name: 'Baby Cloth', number: input5.value, price: price.babyCloth}
                                    setItems((prev) => {
                                        const newArr = [...prev, newObj]
                                        return newArr
                                    });
                    ...
                    <div className='flex bg-orange-400 w-2/3 rounded-2xl justify-center place-items-center gap-4 p-2'>
                        <button onClick = {() => 
                            {setTotalValue(totalValue+input6.value);
                                setEachItem((prev) => {
                                    const newObj = {...prev, name: 'Baby Cloth', number: input6.value, price: price.babyCloth}
                                    setItems((prev) => {
                                        const newArr = [...prev, newObj]
                                        return newArr
                                    });
